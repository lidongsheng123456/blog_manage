  ...
  <div>
    <div class="ManagerDocs-header">
      ...
      <div class="ManagerDocs-header-b">
        <el-button class="el-icon-plus" type="primary" @click="addDocs"> 新增</el-button>
        <el-button class="el-icon-close" type="warning" @click="deleteDocs"> 批量删除</el-button>
      </div>
    </div>
    ...
    <div class="ManagerDocs-content">
      <el-table
        ...
        <el-table-column
            ...
            width="300">
          <template v-slot="scope">
            <el-button class="el-icon-edit" type="primary" @click="editDocs(scope.row)"> 编辑</el-button>
            <el-button class="el-icon-close" type="warning" @click="deleteDocs"> 删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="block">
