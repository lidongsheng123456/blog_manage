  ...
  <div>
    <div class="ManagerUser-header">
      ...
      <div class="ManagerUser-header-b">
        <el-button class="el-icon-plus" type="primary" @click="addUser"> 新增</el-button>
        <el-button class="el-icon-close" type="warning" @click="deleteUser"> 批量删除</el-button>
      </div>
    </div>
    ...
    <div class="ManagerUser-content">
      <el-table
        ...
        <el-table-column
            ...
            width="300">
          <template v-slot="scope">
            <el-button class="el-icon-edit" type="primary" @click="editUser(scope.row)"> 编辑</el-button>
            <el-button class="el-icon-close" type="warning" @click="deleteUser"> 删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="block">
